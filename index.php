...
<div class="container">
  ...
  <div class="row">
   ...
   <div class="col-sm-4">
      <h3>Cr&eacute;ation d'une liste de mots de passes (reg&eacute;n&eacute;rable à l'identique)</h3>
		...
		<p> Une taille en cm (ex : votre taille à vous) ? <input type="number" id="tailleperso" name="tailleperso">
		</p>
	...
	<div class="col-sm-4">
      <h3>Utilisations</h3>
		...
		<p> => Avec ces mêmes champs que vous retiendrez, la liste extensible des mots de passes g&eacute;n&eacute;r&eacute;s sera toujours identique.<p/>
	 ...
	 <h3>Informations</h3>
		...
		Le G&eacute;n&eacute;rateur de mots de passes utilise un g&eacute;n&eacute;rateur particulier de nombre pseudo-al&eacute;atoire (PRNG).
		 Celui-ci admet des entr&eacute;es de tailles non bornées (un espace de graines non born&eacute;). 
